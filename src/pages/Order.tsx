              ...
              <section className="bg-card rounded-lg p-6 shadow-elegant">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    {errors.lastname && (
                      <p className="text-sm text-destructive" data-testid="lastname-error">
                        {errors.lastname}
                      </p>
                    )}
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    {errors.document && (
                      <p className="text-sm text-destructive" data-testid="document-error">
                        {errors.document}
                      </p>
                    )}
                  </div>
              ...
              <section className="bg-card rounded-lg p-6 shadow-elegant">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    {errors.terms && (
                      <p className="text-sm text-destructive mt-1" data-testid="terms-error">
                        {errors.terms}
                      </p>
                    )}
                  </div>
